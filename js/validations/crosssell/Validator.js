(function() {
    "use strict";
    jQuery.sap.declare("sap.ui.validations.crosssell");
    jQuery.sap.require("sap.ui.base.Object");
    sap.ui.base.Object.extend('sap.ui.validations.crosssell', {
    ...
    sap.ui.validations.crosssell.prototype.init = function() {
        var rules, validator;

        jQuery.sap.require("js.validations.BaseValidator", "js.validations.crosssell.Rules");
        validator = new sap.ui.validations.base();
        rules = new sap.rules.CrossSell();
        validator.evaluate(this, rules.getStructure());
        if (this.validated) {
            this.runValidations(rules.getValidations());
        }
    };
    sap.ui.validations.crosssell.prototype.runValidations = function(_exp) {
    ...
    sap.ui.validations.crosssell.prototype.validateRequired = function(_value) {
    ...
    sap.ui.validations.crosssell.prototype.validateMinMax = function(_exp) {

        // console.log("validando minmax")
        var rules, valueMin, valueMax, valueRequiredAmount;

        rules = _exp.rules[0];
        valueMin = parseFloat(this.oModel.getProperty(rules.pathMin));
        valueRequiredAmount = parseFloat(this.oModel.getProperty(rules.pathRequiredAmount));
        valueMax = parseFloat(this.oModel.getProperty(rules.pathMax));

        if (!(valueMin <= valueRequiredAmount && valueMax >= valueRequiredAmount)) {
            console.log("--> no esta entre el rango <--");
            sap.m.MessageToast.show(_exp.message + "$"+valueMin +" a $" + valueMax);
    ...
    sap.ui.validations.crosssell.prototype.validateGuarantor = function(_exp) {
        var hasGuarantor, isGuarantorRequired, rules;
        rules = _exp.rules[0];
        hasGuarantor = this.oModel.getProperty(rules.pathGuarantorId) ? true : false;
        isGuarantorRequired = rules.isGuarantorIdRequired;

        if (hasGuarantor !== isGuarantorRequired) {
            sap.m.MessageToast.show(_exp.message);
            this.currentTab = _exp.tabError;
            this.validated = false;
            this.isTab = _exp.isTab;
    ...
    sap.ui.validations.crosssell.prototype.validatePhoneAndAddress = function(_exp) {
    ...
    sap.ui.validations.crosssell.prototype.validateEmployment = function(_exp) {
    ...
    sap.ui.validations.crosssell.prototype.validateMaritalStatus = function(_exp) {
    ...
    sap.ui.validations.crosssell.prototype.validateLocal = function(_exp) {
    ...
    sap.ui.validations.crosssell.prototype.validateIsIndivWBusiness = function(_exp) {
    ...
    sap.ui.validations.crosssell.prototype.validateDocuments = function(_exp) {
    ...
    sap.ui.validations.crosssell.prototype.validateAdditional = function(_exp) {
    ...
    sap.ui.validations.crosssell.prototype.validateBornDateCredit = function(_exp) {
    ...
    sap.ui.validations.crosssell.prototype.validateGenreProduct = function(_exp) {
